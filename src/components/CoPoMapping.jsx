        ...
        <>
            ...
            <div className='h-[91%] mb-2 overflow-auto'>
                <div className="form-content">
                    <h1 className='font-medium text-lg bg-white sticky top-0 pb-2'>CO-PO and CO-PSO Mapping</h1>
                    ...
                    <div className="tabs-container flex items-center gap-2 mt-2 sticky top-7 bg-white">
                        {tabDatas.map((tab, index) => (
                            ...
                            >
                                <img src={selectedTab === tab.lable ? tab.activeIcon : tab.inActiveIcon} alt={tab.lable} className='w-4 h-4' />
                                <span>{tab.lable}</span>
                            </button>
                        ))}
                    </div>
                                            ...
                                            onChange={(e) => {
                                                setCoPoMapping(prev => ({
                                                    ...
                                                    [selectedTab]: {
                                                        ...prev[selectedTab],
                                                        [item]: {
                                                            justification: prev[selectedTab]?.[item]?.justification || "",
