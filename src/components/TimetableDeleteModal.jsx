...
const TimetableDeleteModal = ({ setIsDelete, deleteData, onSuccess }) => {
    // Authorization
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            console.error("Error occurred while deleting timetable entry: ", err.message);
                ...
                <div className="content-container mt-6">
                    ...
                    <div className="btn-container flex gap-3 justify-center mt-8">
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="font-medium text-md w-[50%] hover:bg-white hover:border border-gray-300 hover:text-black cursor-pointer transition-all duration-300 bg-[#08384F]  bgtext-white rounded-lg px-4 py-2"
                        >
