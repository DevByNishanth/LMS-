...
const StudentTodaysShedule = () => {
    const data = [
        { time: "09:00AM-12:00PM", subject: "Cybersecurity", color: "bg-blue-500" },
        { time: "09:00AM-12:00PM", subject: "C Programming", color: "bg-orange-500" },
        { time: "09:00AM-12:00PM", subject: "Mathematics", color: "bg-pink-500" },
        { time: "09:00AM-12:00PM", subject: "English", color: "bg-green-500" },
    ];
...
export default StudentTodaysShedule;
