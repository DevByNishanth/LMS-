...
import { BookOpenIcon, ChevronDown, ClipboardCheck, FileQuestionMark, FileText, Plus, Search } from 'lucide-react';
                    ...
                    <>
                        <div className="header-container  mb-4">
                            ...
                            <div className="search-container flex items-center gap-2 justify-between mt-4 ">
                                <div className="search-bar border border-gray-300 rounded-lg flex items-center justify-between gap-2 px-2 py-2 w-[60%]">
                                    <input type="text" placeholder='Search classwork..' className='outline-none w-full' />
                        ...
                        <div className="card-container space-y-2 max-h-[calc(100vh-320px)] overflow-auto ">
                            {classWorkData1.map((item, index) => {
                                return <>
                                    <div className="card flex items-center rounded-xl bg-[#F9F9F9] px-4 justify-between border border-gray-300 py-4" key={index}>
                                        ...
                                        <div className='flex items-center gap-2'>
                                            <h1 className='text-[#646464]'>Posted on : {item.postedOn}</h1>
                    ...
                    <>
                        <div className='w-full h-full flex flex-col justify-center items-center gap-4'>
                            ...
                            <div className="text-container text-center ">
                                <h1 className='font-medium text-lg text-[#0B56A4]'>Add a Classwork to get Started !</h1>
                                <h1 className='text-[#777777] w-[80%] m-auto'>Start by adding classwork to share lessons, assignments, and resources with your class.</h1>
                                <button className='bg-[#0B56A4] text-white flex items-center gap-3 py-2 px-4 rounded-lg w-fit m-auto mt-2'><Plus className='text-white' />Create new Classwork</button>
                            </div>
                        </div>
                    </>
                )}
            </section>
            {isAssignmentModalOpen && <AddAssignmentModal setIsAssignmentModalOpen={setIsAssignmentModalOpen} />}
