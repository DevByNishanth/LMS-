        ...
        <section className='w-full p-6 h-full border border-[#DBDBDB] rounded-lg'>
            ...
            <header className='mt-4 flex items-center justify-between relative'>
                ...
                <div className="btn-container">
                    <button onClick={() => setShowAddModal(true)} className='flex items-center cursor-pointer gap-3 text-white bg-[#08384F]  px-5 py-2 rounded-lg'><Plus className="text-white"></Plus> Add</button>
