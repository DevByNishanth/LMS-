...
const allocatedSubjects = [
  {
    ...
    credits: 3,
    classDetails: { year: "3rd Year", department: "B.E CSE", section: "A" },
  },
  {
    subjectCode: "CS6801",
    subject: "Artificial Intelligence and Data Science",
      ...
      <section className="w-full h-screen flex ">
        ...
        <div className="container-2 w-[80%] h-full px-6 ">
          ...
          <div className="tab-container flex gap-4 items-center justify-end mt-4">
            <select
              onChange={(e) => setAccademicYear(e.target.value)}
              className="border px-4 border-gray-400 py-1 rounded"
            >
            ...
            {loading ? (
              ...
              <div className="w-full h-80 flex flex-col items-center justify-center gap-4">
                <img
                  ...
                  alt="No Data Found"
                />
                <p className="text-gray-500 font-medium italic text-lg text-center">
